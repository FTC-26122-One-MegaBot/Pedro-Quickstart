...
public class Auto extends OpMode {
    ...
    private final Pose Pose1 = new Pose(10, 0, Math.toRadians(0)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
    private final Pose Pose2 = new Pose(10, 10, Math.toRadians(0));
...
//        scorePreload.setLinearHeadingInterpolation(startPose.getHeading(), scorePose.getHeading());
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                follower.followPath(scorePreload, 0.3,true);
                setPathState(1);
                break;
            case 1:
