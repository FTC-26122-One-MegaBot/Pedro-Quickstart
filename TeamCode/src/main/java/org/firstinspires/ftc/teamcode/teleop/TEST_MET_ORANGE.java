...
import org.firstinspires.ftc.vision.apriltag.AprilTagProcessor;
    ...
    @TeleOp(name = "TEST_MET_ORANGE")
    public class TEST_MET_ORANGE extends LinearOpMode {
        ...
        private void AutoAim(AprilTagProcessor tagProcessor) {
            ...
            if (!tagProcessor.getDetections().isEmpty()) {
                ...
                if (gamepad2.dpad_down) { // heb 'm nu op player 2 staan, lijkt me handiger? - ken
        ...
        public void revolve(){
           ...
           /*if (Math.abs(Revolver.getCurrentPosition() - target) > 1600){
               ...
               Revolver.setPower(Math.abs((Revolver.getCurrentPosition() - target) * 0.000231 +0.23) * rl);//+min power
                ...
                Revolver.setPower((Math.abs(Revolver.getCurrentPosition()-target)* 0.0231 + 0.23)*rl);
...
//WERKT NOG NIET. MOET NOG AANPASSEN. BLIJF ER VAN AF
            boolean godown;
        ...
        private void Telemetry(AprilTagProcessor tagProcessor) {
            ...
            telemetry.addData("eenwaarde",revolvertarget);
